...
#SBATCH --job-name=PD-null-biome-weighted
...
output_dir=/work/$USER/PD-null-biome-weighted
mkdir -p "$output_dir"
...
Rscript --vanilla $HOME/sPlot-project-FD-PD/01.R-scripts/02.03.02.phylo-calculations-null-biome-weighted.R \
"$input_dir" \
"$output" \
"$start" \
"$end"
