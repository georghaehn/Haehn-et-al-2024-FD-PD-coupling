...
sampled <br> and RQEP and MPD calculated. <br>
...
Four additional variables were present in the sPlot database:

1.  plot size
2.  which plants were recorded in the plot (e.g., all vascular plants,
    only dominant species, all woody plants, only trees)
3.  vegetation type (forest vs. non-forest)
4.  biome
