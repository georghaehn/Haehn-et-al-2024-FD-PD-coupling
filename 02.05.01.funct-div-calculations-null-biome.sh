...
output_dir=/work/$USER/FD-null-biome
mkdir -p "$output_dir"
...
Rscript --vanilla $HOME/sPlot-project-FD-PD/01.R-scripts/02.05.01.funct-div-calculations-null-biome.R \
"$input_dir" \
"$output" \
"$start" \
"$end"
